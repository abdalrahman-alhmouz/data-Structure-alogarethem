...
public class AppTest {
    ...
    public void testInputString() throws Exception {
        ...
        assertEquals("should return first repeated work of summer", "summer", classUnderTest.duplicateWord(input));
    }

    @Test
    public void testMultipleDuplicates() throws Exception {
        String input = "It was the best of times, it was the worst of times";
        assertEquals("should return first repeated work of it", "it", classUnderTest.duplicateWord(input));
    }
